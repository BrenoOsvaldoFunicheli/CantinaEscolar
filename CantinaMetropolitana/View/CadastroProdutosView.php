      ...
      <div class="">
            <div class="container">
                <div class="container col-8 offset-2 form">
                    <div class="row title"><h2 class="col-6 offset-3">Cadastro de Produtos</h2></div>
                    <form action="../Controller/InsertController.php" method="post">
                        <?php
                            ...
                            BSForms::createInput('Preco', 'Preco', $bsDiv, $bsinput, 'text');
                            echo "<input type='hidden' name='tipo' value='".EnumSystemPerson::PRODUTOS."'>";
