...
<html lang="en">
  ...
  <body>
    <?php
        ...
        include '../Helpless/Enum/EnumSystemPerson.php';
        include_once '../Controller/HeaderValidatorController.php';
        HeaderValidatorController::validar(2);
    ?>  
      
      <div class="">
            <div class="container">
                <div class="container col-8 offset-2 form">
                    <div class="row title"><h2 class="col-6 offset-3">Cadastro de Alunos</h2></div>
                    <form action="../Controller/InsertController.php" method="post">
                        <?php
                            ...
                            BSForms::createInput('RA', 'RA', $bsDiv, $bsinput, 'text');
                            BSForms::createInput('senha', 'senha', $bsDiv, $bsinput, 'password');
                            BSForms::createInput('NR', 'Nome do Responsável', $bsDiv, $bsinput, 'text');
                            BSForms::createInput('TR', 'Telefone do Responsável', $bsDiv, $bsinput, 'text');
                            BSForms::createInput('ER', 'Email do Responsável', $bsDiv, $bsinput,'email');
                            
                            echo "<input type='hidden' name='tipo' value='".EnumSystemPerson::ALUNOS."'>";
